...
Only absolute HTTP(S) URIs are accepted. Empty and malformed entries are
ignored. Duplicate IDs resolve deterministically to the first configured
source after priority ordering.
